...
const PriorityCard = ({ priority, rank, teamMembers, onUpdate, onDelete }: PriorityCardProps) => {
  ...
  return (
    <>
      <Card
        className={cn("flex items-center gap-3 px-3 py-2.5 cursor-pointer hover:shadow-md transition-shadow border-border")}
