...
const TaskCard = ({
  ...
  if (depth > 0) {
    return (
      <div className={cn("space-y-1 rounded", isOverdue && "bg-warning/5")} style={{ marginLeft: `${depth * 5}px`, backgroundColor: isOverdue ? undefined : parentStarred ? `rgba(220,38,38,${depth * 0.03})` : `rgba(0,0,0,${depth * 0.025})` }}>
