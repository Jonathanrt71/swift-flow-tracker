...
const items: RoadmapItem[] = [
  ...
  { name: "Push Notifications & Background Badges", category: "Operations", status: "missing", difficulty: TIER.HARD, estimate: "20+ hrs", acgme: "none", rationale: "Full push notification infrastructure: push_subscriptions table, VAPID key pair, service worker push event listener, edge function to send via Web Push API or FCM. Enables badge updates when app is closed and real-time alerts for new feedback, peer practice requests, etc. Android requires FCM; iOS PWA push support has quirks. Many moving parts across platforms. Build after client-side badge count proves the concept." },
