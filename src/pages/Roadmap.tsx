...
const items: RoadmapItem[] = [
  // ── EASY · RESIDENT-FACING ──
  { name: "Site-Wide Search", category: "Operations", status: "missing", difficulty: TIER.EASY, estimate: "4–6 hrs", acgme: "none", rationale: "Search input in the header that queries across handbook_sections, events, tasks, announcements, and other key tables using ilike matching. Returns grouped results by section. No AI needed — fully deterministic. Quick win for navigation across growing content. Residents can instantly find handbook policies, rotation info, and announcements." },
  { name: "Wellness Resource Directory", category: "Wellness", status: "partial", difficulty: TIER.EASY, estimate: "2–3 hrs", acgme: "medium", rationale: "Static content page with EAP contacts, mental health resources, fitness info. Could be a Handbook section or standalone page. Mostly content entry. Directly serves resident wellbeing — one-tap access to support resources." },
  { name: "Conference Presentation Tracking", category: "Scholarly", status: "missing", difficulty: TIER.EASY, estimate: "2–3 hrs", acgme: "medium", rationale: "Part of Scholarly Activity module, but standalone it's just a log: resident, title, conference, date, type (poster/oral). Simple CRUD. Residents track their own presentations and build their CV." },
  { name: "Orientation Materials / Welcome Package", category: "Recruitment", status: "partial", difficulty: TIER.EASY, estimate: "2–3 hrs", acgme: "low", rationale: "Curate existing Handbook and Rotation content into a dedicated 'New Resident' landing page with quick links. Content assembly, not new features. Incoming residents get a clear starting point." },
  { name: "Advisor / Mentorship Assignments", category: "Personnel", status: "missing", difficulty: TIER.EASY, estimate: "2–3 hrs", acgme: "medium", rationale: "Add a mentor_id FK on profiles, a dropdown on Resident Summary, and display it. Minimal UI, no new page needed. Residents see who their assigned mentor is." },
  { name: "Simulation / Skills Lab Tracking", category: "Curriculum", status: "missing", difficulty: TIER.EASY, estimate: "3–4 hrs", acgme: "low", rationale: "Filter/view within existing Procedure Logs for sim entries. Add a sim-specific summary card. Minimal new code — mostly a filtered view of existing data. Residents see their sim experience alongside real procedures." },

  // ── EASY · ADMIN/FACULTY-FACING ──
  { name: "Faculty Roster / Directory", category: "Personnel", status: "partial", difficulty: TIER.EASY, estimate: "3–4 hrs", acgme: "medium", rationale: "Query existing profiles filtered to faculty role. New page with card layout showing credentials, role, teaching areas. Data already exists. Residents can look up faculty, but primarily an admin/display feature." },
  ...
  // ── MODERATE · RESIDENT-FACING ──
  { name: "Scholarly Activity Module", category: "Scholarly", status: "missing", difficulty: TIER.MODERATE, estimate: "8–12 hrs", acgme: "critical", rationale: "Project registry with status workflow, type categorization, mentor assignment, milestone dates. Presentation/publication sub-records. ACGME requires documented scholarly activity for every resident. Residents track their own QI and research projects." },
  ...
  { name: "Onboarding Checklist", category: "Recruitment", status: "missing", difficulty: TIER.MODERATE, estimate: "6–8 hrs", acgme: "medium", rationale: "Checklist template (admin-configurable items), per-resident instance with completion tracking, deadline management. New page + two tables. Reusable annually. Incoming residents track their own onboarding progress." },

  // ── MODERATE · ADMIN/FACULTY-FACING ──
  ...
  // ── HARD · RESIDENT-FACING ──
  { name: "Leave / Absence Tracking", category: "Personnel", status: "missing", difficulty: TIER.HARD, estimate: "12–16 hrs", acgme: "critical", rationale: "Request/approval workflow, multiple leave types with different balance rules, impact on training time calculations, integration with block schedule. ACGME requires programs to track time away and determine impact on meeting training requirements for graduation. Residents submit and track their own leave." },
  { name: "Graduation Readiness Dashboard", category: "Recruitment", status: "missing", difficulty: TIER.HARD, estimate: "12–16 hrs", acgme: "critical", rationale: "Aggregates completion status from procedures, evaluations, milestones, scholarly activity, leave/time, and rotations into a single per-resident view. Residents see exactly where they stand for graduation." },
