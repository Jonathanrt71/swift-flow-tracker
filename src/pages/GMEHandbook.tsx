...
const GMEHandbook = () => {
  ...
  const startEditing = (s: GMEHandbookSection) => {
  ...
  // ── TOC Item ─────────────────────────────────────────────────────────
  const TocItem = ({ section, depth = 0 }: { section: GMEHandbookSection; depth?: number }) => {
      ...
      <div style={{ display: "flex", height: "calc(100vh - 56px)", position: "relative", overflow: "hidden" }}>
        ...
        <aside style={{
          ...
          <div style={{ padding: "14px 16px 10px", borderBottom: "1px solid #E7EBEF" }}>
            <div style={{ fontSize: 11, fontWeight: 600, color: "#415162", textTransform: "uppercase", letterSpacing: 0.8 }}>GME Policy Handbook</div>
          </div>
        ...
        <div ref={contentRef} style={{ flex: 1, overflowY: "auto", padding: "24px 20px 120px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            ...
            <h1 style={{ fontSize: 22, fontWeight: 600, color: "#2D3748", margin: 0 }}>GME Handbook</h1>
          </div>
